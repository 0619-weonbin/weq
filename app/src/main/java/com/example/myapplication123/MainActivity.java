...
public class MainActivity extends AppCompatActivity {
    ...
    private void getWeatherData() {
        weatherService.getWeather("Seoul", apiKey, "metric").enqueue(new Callback<com.example.myapplication123.models.WeatherData>() {
            @Override
            public void onResponse(Call<com.example.myapplication123.models.WeatherData> call, Response<com.example.myapplication123.models.WeatherData> response) {
                if (response.isSuccessful() && response.body() != null) {
                    com.example.myapplication123.models.WeatherData weatherData = response.body();
            ...
            for (ForecastResponse.ForecastItem forecastItem : forecastList) {
                ...
                if (forecastItem.getWeather() != null) {
                    for (ForecastResponse.Weather weatherItem : forecastItem.getWeather()) {
                        ...
                        weatherInfo.setMain(weatherItem.getMain()); // weather의 main 추가
